...
public class BookPageView extends View {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        pathBPaint.setColor(ContextCompat.getColor(context, R.color.lightSkyBlue));
...
//        pathCPaint.setStyle(Paint.Style.STROKE);
    ...
    protected void drawPathAContentBitmap(Bitmap bitmap, Paint pathPaint) {
    ...
    protected void drawPathBContentBitmap(Bitmap bitmap, Paint pathPaint) {
        Canvas mCanvas = new Canvas(bitmap);
        //下面开始绘制区域内的内容...
        mCanvas.drawPath(getPathDefault(), pathPaint);
